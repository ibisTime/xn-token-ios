...
@interface YZViewController ()<MSAuthProtocol>
...
- (void)viewDidLoad {
    ...
    NSString *tokenK = [SecurityVerification doJAQVerfificationSync:nil timeout:10];
    NSLog(@"%@",tokenK);
    UIViewController *vc = [MSAuthVCFactory simapleVerifyWithType:(MSAuthTypeSlide) language:@"zh_CN" Delegate:self authCode:nil appKey:nil];
