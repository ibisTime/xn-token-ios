...
//        _DownloadButton.frame=CGRectMake(WIDTH/2-50, HEIGHT-80, 100, 30);
//        _DownloadButton.titleLabel.font=[UIFont systemFontOfSize:15];
//        [_DownloadButton setTitle:@"下载原图" forState:(UIControlStateNormal)];
//        [_DownloadButton setBackgroundImage:[UIImage imageNamed:@"Downloadbutton"] forState:(UIControlStateNormal)];
//        _DownloadButton.tag=self.index;
//        [_DownloadButton addTarget:self action:@selector(button:) forControlEvents:(UIControlEventTouchUpInside)];
//    }
//    return _DownloadButton;
//}
//-(void)button:(UIButton *)sender{
//    UIImageWriteToSavedPhotosAlbum(self.photoView.imageView.image, self, @selector(imageSavedToPhotosAlbum:didFinishSavingWithError:contextInfo:), nil);
//}
