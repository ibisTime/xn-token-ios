...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *nameLabel = [UILabel labelWithFrame:CGRectMake(0, 55, SCREEN_WIDTH - 100, 18) textAligment:(NSTextAlignmentCenter) backgroundColor:kClearColor font:FONT(14) textColor:kHexColor(@"#000000")];
        ...
        UILabel *totalLabel = [UILabel labelWithFrame:CGRectMake(0, nameLabel.yy + 11, SCREEN_WIDTH - 100, 12) textAligment:(NSTextAlignmentCenter) backgroundColor:kClearColor font:FONT(12) textColor:kHexColor(@"#000000")];
        ...
        promptBtn.frame = CGRectMake(0, IKonwBtn.yy + 60, SCREEN_WIDTH - 100, 14);
